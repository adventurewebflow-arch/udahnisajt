  ...
  return (
    <main>
      ...
      <section className="py-16 md:py-24 relative">
        <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-white">Priče sa tura</h2>
            <div className="w-14 h-1 bg-emerald-400 mt-3 mb-3" />
            <Link href="/vodici" className="inline-block text-sm text-emerald-400 hover:text-emerald-300 transition">
              Sve priče →
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.slice(0, 3).map((post) => (
              <Link key={post.slug} href={`/vodici/${post.slug}`} className="group block">
