  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.154 1.528 5.923L0 24l6.266-1.503A11.954 11.954 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 0 1-5.006-1.37l-.36-.214-3.72.892.936-3.62-.235-.373A9.818 9.818 0 1 1 12 21.818z" />
      </svg>
    </a>
  );
}
