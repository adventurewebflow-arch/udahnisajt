...
export const adventures: Adventure[] = [
  // POPULAR TOURS
  {
    ...
    images: [
      ...
      { src: "/images/tours/gallery/put-za-jezero.webp", alt: "Put za jezero" },
      ...
      { src: "/images/tours/gallery/odmor-na-trnovackom.webp", alt: "Odmor na Trnovačkom jezeru" },
      ...
      { src: "/images/tours/gallery/ekipa-na-vidikovcu-trnovacko.webp", alt: "Ekipa na vidikovcu Trnovačko jezero" },
    ],
    highlights: [
      "Trnovačko jezero",
      "Uspon na Maglić",
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/tours/gallery/put-na-boric.jpg", alt: "Put na vidikovac Borić" },
      { src: "/images/tours/gallery/put-na-vidikovac-boric.jpg", alt: "Staza do vidikovca Borić" },
      { src: "/images/tours/gallery/na-boricu.jpg", alt: "Na vidikovcu Borić" },
      { src: "/images/tours/gallery/boric-stizemo.jpg", alt: "Stižemo na Borić" },
      { src: "/images/tours/gallery/pauza-do-vidikovca.jpg", alt: "Pauza na putu do vidikovca" },
      { src: "/images/tours/gallery/boric-zelengora.jpg", alt: "Borić Zelengora" },
      { src: "/images/tours/gallery/nevena-i-ja-boric-zelengora.jpg", alt: "Na Boriću Zelengora" },
      { src: "/images/tours/gallery/boric-vidikovac-zelengora.jpg", alt: "Vidikovac Borić Zelengora" },
      { src: "/images/tours/gallery/vidikovac-zelengora.jpg", alt: "Vidikovac Zelengora" },
      { src: "/images/tours/gallery/aleksa-na-zelengori.jpg", alt: "Na Zelengori" },
      { src: "/images/tours/gallery/slika-na-boricu-zelengora.jpg", alt: "Borić Zelengora panorama" },
      { src: "/images/tours/gallery/pauza-zelengora.jpg", alt: "Pauza na Zelengori" },
      { src: "/images/tours/gallery/uzivanje-zelengora.jpg", alt: "Uživanje na Zelengori" },
      { src: "/images/tours/gallery/sikanje-na-zelengori.jpg", alt: "Zelengora planina" },
      { src: "/images/tours/gallery/zelengora-slika-boric.jpg", alt: "Zelengora Borić" },
      { src: "/images/tours/gallery/pauza-na-vidikovcu-zelengora.jpg", alt: "Pauza na vidikovcu Zelengora" },
      { src: "/images/tours/gallery/boric-zelengora-pogled.jpg", alt: "Pogled sa Borića Zelengora" },
      { src: "/images/tours/gallery/put-do-borica.jpg", alt: "Put do Borića" },
      { src: "/images/tours/gallery/kanjon-sutjeske-zelengora.jpg", alt: "Kanjon Sutjeske sa Zelengore" },
      { src: "/images/tours/gallery/par-na-zelengori.jpg", alt: "Par na Zelengori" },
    ],
    highlights: [
      "Orlovačko jezero",
  ...
  },
  {
    ...
    title: "Vikend u divljini",
    category: "popular",
    location: "NP Sutjeska / Tjentište",
...
Smještaj biraš ti — bungalov sa zajedničkim kupatilom ili šator (oprema obezbijeđena). PDF možeš preuzeti na kraju stranice.`,
    ...
    highlights: [
      ...
      "Licencirani vodiči",
      "Avans 50€, ostatak po dolasku",
    ],
    itinerary: [
      {
        dayTitle: "Dan 1 (Petak) — Dolazak i prvi utisci",
        description:
    ...
    includes: [
      "2 noći smještaja u kampu Tjentište (bungalov ili šator po izboru)",
      "3 obroka (2 doručka + 1 večera u restoranu kampa)",
      "2 lunch paketa (subota i nedjelja)",
      "Prevoz terenskim vozilima",
      "Licencirani vodiči",
      "Ulaznice NP Sutjeska i PP Piva",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Da, tura je pogodna i za djecu uz pratnju roditelja. Program je fleksibilan — tempo prilagođavamo grupi.",
      },
    ],
  },
  // PREMIUM TOUR
